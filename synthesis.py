...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    /* Two-panel scroll: editorial (top) / quant (bottom) */
    @media (prefers-reduced-motion: no-preference) {
      html, body { height: 100%; overflow: hidden; margin: 0; }
      .page-wrap { height: 100vh; overflow-y: scroll; scroll-snap-type: y mandatory; scroll-behavior: smooth; }
      .panel-top { height: 100vh; overflow-y: auto; scroll-snap-align: start; overscroll-behavior: contain; }
      .panel-bottom { min-height: 100vh; overflow-y: auto; scroll-snap-align: start; overscroll-behavior: contain; }
    }
    @media (prefers-reduced-motion: reduce) {
      .panel-top, .panel-bottom { display: block; }
    }
...
<body>
  ...
  <div class="page-wrap">
  <!-- ── Panel 1: Editorial (100 vh, scrolls internally) ────────────── -->
  <div class="panel-top">
    <div class="sheet">
  ...
  <!-- ── Panel 2: Quant (scrolls internally) ────────────────────────── -->
...
_REGIME_ASSET_TILT: dict[str, list[dict]] = {
    "Goldilocks": [
        {"asset": "Equities",       "tilt": "overweight", "icon": "✅"},
        {"asset": "Credit",         "tilt": "overweight", "icon": "✅"},
        {"asset": "Real Assets",    "tilt": "neutral",    "icon": "⚖️"},
        {"asset": "Long Bonds",     "tilt": "neutral",    "icon": "⚖️"},
        {"asset": "Cash",           "tilt": "underweight","icon": "⬇️"},
        {"asset": "Gold",           "tilt": "neutral",    "icon": "⚖️"},
    ],
    "Overheat": [
        {"asset": "Equities",       "tilt": "overweight", "icon": "✅"},
        {"asset": "Commodities",    "tilt": "overweight", "icon": "✅"},
        {"asset": "Real Assets",    "tilt": "overweight", "icon": "✅"},
        {"asset": "EM Assets",      "tilt": "overweight", "icon": "✅"},
        {"asset": "Long Bonds",     "tilt": "underweight","icon": "⬇️"},
        {"asset": "Cash",           "tilt": "underweight","icon": "⬇️"},
    ],
    "Stagflation": [
        {"asset": "Gold",           "tilt": "overweight", "icon": "✅"},
        {"asset": "Commodities",    "tilt": "overweight", "icon": "✅"},
        {"asset": "Real Assets",    "tilt": "overweight", "icon": "✅"},
        {"asset": "Equities",       "tilt": "underweight","icon": "⬇️"},
        {"asset": "Long Bonds",     "tilt": "underweight","icon": "⬇️"},
        {"asset": "Credit",         "tilt": "underweight","icon": "⬇️"},
    ],
    "Deflationary Bust": [
        {"asset": "Long Bonds",     "tilt": "overweight", "icon": "✅"},
        {"asset": "Cash",           "tilt": "overweight", "icon": "✅"},
        {"asset": "Gold",           "tilt": "neutral",    "icon": "⚖️"},
        {"asset": "Equities",       "tilt": "underweight","icon": "⬇️"},
        {"asset": "Credit",         "tilt": "underweight","icon": "⬇️"},
        {"asset": "Commodities",    "tilt": "underweight","icon": "⬇️"},
    ],
}
